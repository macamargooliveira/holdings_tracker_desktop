...
def upgrade() -> None:
    ...
    sa.Column('event_type', sa.Enum('SPLIT', 'REVERSE_SPLIT', 'AMORTIZATION', 'SUBSCRIPTION', 'TOTAL_CONVERSION', name='asseteventtype'), nullable=False),
    ...
    sa.Column('target_quantity', sa.Numeric(precision=20, scale=6), nullable=True),
    sa.Column('target_unit_price', sa.Numeric(precision=20, scale=6), nullable=True),
